				...
				<form name="addParkingArea"
					...
					<table>
						...
						<tr>
							...
							<input id="cameraOption" type="checkbox" name="checkedCartOptions" value="camera">Camera
							 <input id="cartOption" type="checkbox" name="checkedCartOptions" value="cart">Cart
							<input id="historyOption"  type="checkbox" name="checkedCartOptions" value="history">History
						</tr>
						<tr>
