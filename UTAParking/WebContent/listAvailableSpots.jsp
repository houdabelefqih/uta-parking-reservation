...
<input id= "selectError" name="errMsg" value="<c:out value='${selectError}'/>" type="text" style ="background-color: white; color: red; border: none; width:800px" disabled="disabled">
