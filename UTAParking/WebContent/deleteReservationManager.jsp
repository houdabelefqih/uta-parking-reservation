...
<tr>
<td>
<form name="deleteReservationManagerController" action="DeleteReservationManagerController" method="post" style="width: 300px; ">
<table>
...
<table class="myTable"> 
			...
			<tr class="myTableRow"> 
				...
				<th class="myTableCell" style="width: 180px; ">
					<form action="DeleteReservationManagerController">
