...
@Test
@FileParameters("src/ExcelTestCases/ConfirmSelectTestCases.csv")
  public void testConfirmSelect(int testCaseNumber,String username, String password, String parking_type, 
		  String start_time, String duration, String selectError) throws Exception {	
	  ...
	  //RequestReservation
  		...
  		assertEquals(selectError, driver.findElement(By.id(prop.getProperty("Txt_ConfirmReservation_SelectError"))).getAttribute("value"));
