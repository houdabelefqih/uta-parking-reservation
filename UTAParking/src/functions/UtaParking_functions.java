...
public class UtaParking_functions {
	 ...
	 * @throws InterruptedException *
	 */
	public void UPA_BF_searchUser(WebDriver driver, String userName) throws InterruptedException {
...
//	**************************************************************************************************
	public void UPA_BF_ManageParkingArea(WebDriver driver, int basic, int midRange, int premium, int access,
		...
		driver.findElement(By.id("cameraOption")).click();
		driver.findElement(By.id("historyOption")).click();
		driver.findElement(By.id("cartOption")).click();
