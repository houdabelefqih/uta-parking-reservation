...
@WebServlet("/ModifyReservationsManagerController")
public class ModifyReservationsManagerController extends HttpServlet{
...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("Submit")) {
			...
			url = "/modifyReservationsManager.jsp.";			
			}
			getServletContext().getRequestDispatcher("/modifyReservationsManager.jsp").forward(request, response);
		}
}